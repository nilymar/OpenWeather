...
class WeatherWidgetProvider : AppWidgetProvider() {
    ...
    override fun onEnabled(context: Context) {
        ...
        val defaultViews = RemoteViews(context.packageName, R.layout.weather_widget)
        val comp = ComponentName(context.packageName, WeatherWidgetProvider::class.java.name)
    ...
    companion object {
        val LOG_TAG: String = WeatherWidgetProvider::class.java.name
        ...
        private fun getSmallRemoteView(context: Context, weather: ForecastWeather?, widgetId: Int): RemoteViews {
            ...
            if (isDay) { // if it is day - the text is black and background light
            ...
            } else { // if it is night - the text is white and background dark
