 ...
 */
class WideWidgetUpdateJobIntentService : JobIntentService() {
    ...
    override fun onHandleWork(intent: Intent) {
        ...
        if (intent.action != null) {
            ...
            if (AppConstants.ACTION_UPDATE_WEATHER_WIDGET_ONLINE == action) {
     ...
     */
    fun handleActionUpdateWeatherWidget() {
        var weather: ForecastWeather? = null
        val appWidgetManager = AppWidgetManager.getInstance(this)
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(
                this,
                WeatherWideWidgetProvider::class.java
            )
        )
    ...
    companion object {
        val LOG_TAG: String = WideWidgetUpdateJobIntentService::class.java.name
        ...
        fun enqueueWork(
            ...
            val intent = Intent(context, WideWidgetUpdateJobIntentService::class.java)
            intent.putExtra(RECEIVER, workerResultReceiver)
            intent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, id)
            intent.action = action
            enqueueWork(context, WideWidgetUpdateJobIntentService::class.java, JOB_ID, intent)
        }
    }
}
